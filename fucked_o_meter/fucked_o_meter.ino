...
#define WLAN_SSID       "Greynet"
#define WLAN_PASS       "CaptainMorgan"
...
{  
  ...
  rest.set_id("008");
  rest.set_name("fucked_o_meter");
  
  // Set up CC3000 and get connected to the wireless network.
  Serial.println("Waiting for CC3000");
  if (!cc3000.begin())
  {
    while(1);
  }
  Serial.println("Waiting for WLAN");
